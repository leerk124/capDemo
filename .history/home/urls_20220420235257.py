...
urlpatterns = [
    ...
    path('dogeGraphs/bitcoinHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraphs/')),
    path('dogeGraphs/cardanoHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraphs/')),
    path('dogeGraphs/dogeHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraphs/')),
    path('dogeGraphs/ethereumHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraphs/')),
    path('dogeGraphs/heliumHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/heliumGraphs/')),
    path('dogeGraphs/litecoinHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/litecoinGraphs/')),
    path('dogeGraphs/polkadotHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/polkadotGraphs/')),
    path('dogeGraphs/shibainuHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/shibainuGraphs/')),
    path('dogeGraphs/tetherHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/tetherGraphs/')),

    #DOGE TO HISTORY TO HISTORY
    path('dogeHistory/bitcoinHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraphs/')),
    path('dogeHistory/cardanoHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraphs/')),
    path('dogeHistory/dogeHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraphs/')),
    path('dogeHistory/ethereumHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraphs/')),
    path('dogeHistory/heliumHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/heliumGraphs/')),
    path('dogeHistory/litecoinHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/litecoinGraphs/')),
    path('dogeHistory/polkadotHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/polkadotGraphs/')),
    path('dogeHistory/shibainuHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/shibainuGraphs/')),
    path('dogeHistory/tetherHistory/',
         RedirectView.as_view(url='http://127.0.0.1:8000/tetherGraphs/')),
