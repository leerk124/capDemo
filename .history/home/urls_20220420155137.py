...
urlpatterns = [
    ...
    path('bitcoinGraph/bitcoinGraph/', RedirectView.as_view(url='http://127.0.0.1:8000/bitcoin/')),
    path('bitcoinGraph/cardanoGraph/', RedirectView.as_view(url='http://127.0.0.1:8000/cardano/')),
    path('bitcoinGraph/dogeGraph/', RedirectView.as_view(url='http://127.0.0.1:8000/doge/')),
    path('bitcoinGraph/ethereumGraph/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereum/')),
