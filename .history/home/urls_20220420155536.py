...
urlpatterns = [
    ...
    path('bitcoinGraphs/bitcoinGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraph/')),
    path('bitcoinGraphs/cardanoGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraph/')),
    path('bitcoinGraphs/dogeGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraph/')),
    path('bitcoinGraphs/ethereumGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraph/')),
