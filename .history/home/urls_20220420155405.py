...
urlpatterns = [
    ...
    path('bitcoinGraph/bitcoinGraph/', RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraph/')),
    path('bitcoinGraph/cardanoGraph/', RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraph/')),
    path('bitcoinGraph/dogeGraph/', RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraph/')),
    path('bitcoinGraph/ethereumGraph/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraph/')),
