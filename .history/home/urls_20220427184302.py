...
urlpatterns = [
    ...
    path('home/', RedirectView.as_view(url='http://127.0.0.1:8000/')),
    ...
    path('bitcoinHistory/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('bitcoinHistory/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('bitcoinHistory/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('bitcoinHistory/polkadotHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('bitcoinHistory/shibainuHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('bitcoinHistory/tetherHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),
    ...
    path('dogeGraphs/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('dogeGraphs/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('dogeGraphs/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('dogeGraphs/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('dogeGraphs/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('dogeGraphs/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('dogeGraphs/polkadotHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('dogeGraphs/shibainuHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('dogeGraphs/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),
    ...
    path('dogeHistory/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('dogeHistory/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('dogeHistory/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('dogeHistory/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('dogeHistory/heliumHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('dogeHistory/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('dogeHistory/polkadotHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('dogeHistory/shibainuHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('dogeHistory/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),
    ...
    path('litecoinGraphs/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('litecoinGraphs/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('litecoinGraphs/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('litecoinGraphs/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('litecoinGraphs/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('litecoinGraphs/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('litecoinGraphs/polkadotHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('litecoinGraphs/shibainuHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('litecoinGraphs/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),
    path('litecoinGraphs/home/', RedirectView.as_view(url='http://127.0.0.1:8000/')),

    #LITECOIN HISTORY TO GRAPH
    path('litecoinHistory/bitcoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraphs/')),
    path('litecoinHistory/cardanoGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraphs/')),
    path('litecoinHistory/dogeGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraphs/')),
    path('litecoinHistory/ethereumGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraphs/')),
    path('litecoinHistory/heliumGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumGraphs/')),
    path('litecoinHistory/litecoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinGraphs/')),
    path('litecoinHistory/polkadotGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotGraphs/')),
    path('litecoinHistory/shibainuGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuGraphs/')),
    path('litecoinHistory/tetherGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherGraphs/')),
    path('litecoinHistory/home/', RedirectView.as_view(url='http://127.0.0.1:8000/')),
    
    #LITECOIN HISTORY TO HISTORY
    path('litecoinHistory/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('litecoinHistory/cardanoHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('litecoinHistory/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('litecoinHistory/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('litecoinHistory/heliumHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('litecoinHistory/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('litecoinHistory/polkadotHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('litecoinHistory/shibainuHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('litecoinHistory/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),

    #######################################POLKADOT###################################################
    #POLAKDOT GRAPH TO GRAPH
    ...
    #POLKADOT GRAPH TO HISTORY
    path('polkadotGraphs/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('polkadotGraphs/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('polkadotGraphs/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('polkadotGraphs/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('polkadotGraphs/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('polkadotGraphs/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('polkadotGraphs/polkadotHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('polkadotGraphs/shibainuHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('polkadotGraphs/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),

    #POLKADOT HISTORY TO GRAPH
    path('polkadotHistory/bitcoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraphs/')),
    path('polkadotHistory/cardanoGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraphs/')),
    path('polkadotHistory/dogeGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraphs/')),
    path('polkadotHistory/ethereumGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraphs/')),
    path('polkadotHistory/heliumGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/heliumGraphs/')),
    path('polkadotHistory/litecoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinGraphs/')),
    path('polkadotHistory/polkadotGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotGraphs/')),
    path('polkadotHistory/shibainuGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuGraphs/')),
    path('polkadotHistory/tetherGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherGraphs/')),
    path('polkadotHistory/home/', RedirectView.as_view(url='http://127.0.0.1:8000/')),

    #POLKADOT HISTORY TO HISTORY
    path('polkadotHistory/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('polkadotHistory/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('polkadotHistory/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('polkadotHistory/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('polkadotHistory/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('polkadotHistory/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('polkadotHistory/polkadotHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('polkadotHistory/shibainuHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('polkadotHistory/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),

    #########################################SHIBAINU##########################################
    #SHIBAINU GRAPH TO GRAPH
    ...
    #SHIBAINU GRAPH TO HISTORY
    path('shibainuGraphs/bitcoinHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('shibainuGraphs/cardanoHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('shibainuGraphs/dogeHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('shibainuGraphs/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('shibainuGraphs/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('shibainuGraphs/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('shibainuGraphs/polkadotHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('shibainuGraphs/shibainuHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('shibainuGraphs/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),

    #SHIBAINU HISTORY TO GRAPH
    path('shibainuHistory/bitcoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraphs/')),
    path('shibainuHistory/cardanoGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraphs/')),
    path('shibainuHistory/dogeGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraphs/')),
    path('shibainuHistory/ethereumGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraphs/')),
    path('shibainuHistory/heliumGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/heliumGraphs/')),
    path('shibainuHistory/litecoinGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/litecoinGraphs/')),
    path('shibainuHistory/polkadotGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/polkadotGraphs/')),
    path('shibainuHistory/shibainuGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuGraphs/')),
    path('shibainuHistory/tetherGraphs/', RedirectView.as_view(url='http://127.0.0.1:8000/tetherGraphs/')),

    #SHIBAINU HISTORY TO HISTORY
    path('shibainuHistory/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('shibainuHistory/cardanoHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('shibainuHistory/dogeHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('shibainuHistory/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('shibainuHistory/heliumHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('shibainuHistory/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('shibainuHistory/polkadotHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('shibainuHistory/shibainuHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('shibainuHistory/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),
    path('shibainuHistory/home/', RedirectView.as_view(url='http://127.0.0.1:8000/')),


    ###################################################TETHER##########################################
    #TETHER GRAPH TO GRAPH
    ...
    #TETHER GRAPH TO HISTORY
    path('tetherGraphs/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('tetherGraphs/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('tetherGraphs/dogeHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('tetherGraphs/ethereumHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
    path('tetherGraphs/heliumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumHistory/')),
    path('tetherGraphs/litecoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinHistory/')),
    path('tetherGraphs/polkadotHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/polkadotHistory/')),
    path('tetherGraphs/shibainuHistory/', RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('tetherGraphs/tetherHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),

    #TETHER HISTORY TO GRAPH
    path('tetherHistory/bitcoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinGraphs/')),
    path('tetherHistory/cardanoGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoGraphs/')),
    path('tetherHistory/dogeGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeGraphs/')),
    path('tetherHistory/ethereumGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumGraphs/')),
    path('tetherHistory/heliumGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/heliumGraphs/')),
    path('tetherHistory/litecoinGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/litecoinGraphs/')),
    path('tetherHistory/polkadotGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/polkadotGraphs/')),
    path('tetherHistory/shibainuGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuGraphs/')),
    path('tetherHistory/tetherGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherGraphs/')),

    #TETHER HISTORY TO HISTORY
    path('tetherHistory/bitcoinHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/bitcoinHistory/')),
    path('tetherHistory/cardanoHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/cardanoHistory/')),
    path('tetherHistory/dogeHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/dogeHistory/')),
    path('tetherHistory/ethereumHistory/',RedirectView.as_view(url='http://127.0.0.1:8000/ethereumHistory/')),
