...
urlpatterns = [
    ...
    path('ethereumHistory/shibainuGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/shibainuHistory/')),
    path('ethereumHistory/tetherGraphs/',RedirectView.as_view(url='http://127.0.0.1:8000/tetherHistory/')),
