...
def graphs(data_frame_needed):
    ...
    graph_html_list.append(volume_graph.to_html(full_html=False, default_height=600, default_width=1200))
    graph_html_list.append(candleStick_graph.to_html(full_html=False, default_height=600, default_width=1200))
